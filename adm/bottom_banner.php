            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Add Right Banner</h1>
                    ...
                    <div class="row">
                             ...
                             <div class="col-md-4">
                               <div class="form-group">
                                <label for="exampleInputEmail1">Right Banner Image</label>
                             
                                <input type="file" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Category Name" name="bottombanner_img" accept="image/*">
                            ...
                            {
                              ?>
                               <button type="submit" class="btn btn-primary" name="btn_add_bottombanner">Submit</button>
                              <?php
                            }
                            ?>
                            </form>
                      ...
                      if(isset($_GET['del_banner']))
                      {
                        ...
                        if(is_numeric($id))
                        {
                         mysqli_query($con,"update tbl_right_banner set status=0 where id='$id'");
                        }
                      }
$fetch_banner=mysqli_query($con,"select * from  tbl_right_banner where status=1");
while($res_banner=mysqli_fetch_array($fetch_banner))
{
                      ?>
                      <div class="col-md-4"> 
                       <a href="bottom_banner.php?del_banner=<?=$res_banner['id'];?>" class="float-right" style="color: red;"> <i class="fa fa-trash"></i></a>
