...
if(isset($_GET['id']))
{
  ...
  if(is_numeric($id))
  {
      $fetch=mysqli_query($con,"select * from tbl_service where id='$id' and status=1");
...
if(isset($_GET['success'])=='success')
{
 ...
 <p>Successfully Added Service..!</p> 
</div>
  <?php
}
?>
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Service<a href="manage_service.php" class="btn btn-warning" style="float: right;"><i class="fa fa-table"></i> Service List</a></div>
                            <div class="card-body">
...
{
  ?>
  <button type="submit" class="btn btn-primary" name="btn_update_service">Update</button>
  <?php
}
else
{
  ?>
    <button type="submit" class="btn btn-primary" name="btn_add_service">Submit</button>
  <?php
}
?>
