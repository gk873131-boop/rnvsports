...
{
$query="SELECT * FROM tbl_product WHERE status=1 ORDER BY product_name ASC";
}
else if($value=='product_name_desc')
{
    $query="SELECT * FROM tbl_product WHERE status=1 ORDER BY product_name DESC";
...
{
    $query="SELECT * FROM tbl_product WHERE status=1 ORDER BY sale_price DESC";
}
