...
{
$query="SELECT * FROM tbl_product WHERE sale_price BETWEEN '".$_POST["minimum_range"]."' AND '".$_POST["maximum_range"]."' AND category_id='$category_id' ORDER BY sale_price ASC
";
}
else
{
